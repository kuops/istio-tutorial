...
# kubectl get svc -n istio-system grafana-nodeport 
NAME               TYPE       CLUSTER-IP       EXTERNAL-IP   PORT(S)          AGE
grafana-nodeport   NodePort   10.107.217.218   <none>        3000:32040/TCP   45s
```
...
http://nodeip:32040/graph?g0.range_input=1m&g0.stacked=1&g0.expr=&g0.tab=0
----
