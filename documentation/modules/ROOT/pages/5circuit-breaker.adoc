...
不要马上返回失败，而应该重试该服务 n 次以上

我们将让 pod recommendation-v2 在百分之百的时间内返回失败. 使用以下命令获取 pod 名称
...
你现在应该已经进入 pod 的容器 `recommendation-v2-2036617847-spdrb` 中. 现在执行:
...
这是一个特殊的 uri，可以让我们的程序只返回 `503`s.

现在你访问 customer 服务, 你应该可以看到一些 503's

[source,bash, subs="+macros,+attributes"]
----
# for i in `seq 1 10`;do curl $INGRESS_HOST:$INGRESS_PORT;done

customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 5
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 6
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 7
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 8
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 9
----
...
你现在应该看到每次请求都是有效的，因为 Istio 将重试 recommendation 服务并且只能在 `v1` 登录.

[source,bash,subs="+macros,+attributes"]
----
# for i in `seq 1 3`;do curl $INGRESS_HOST:$INGRESS_PORT;done

customer => preference => recommendation v1 from '76d747d99f-25h79': 10
customer => preference => recommendation v1 from '76d747d99f-25h79': 11
customer => preference => recommendation v1 from '76d747d99f-25h79': 12
----

你可以查看当前正在使用的  virtualservice

[source,bash,subs="+macros,+attributes"]
----
istioctl get virtualservices -n tutorial recommendation -o yaml
----

现在我们删除重试规则返回之前的状态, v2 将返回 503
...
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 13
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 14
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 15
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 16
customer => 503 preference => 503 recommendation misbehavior from 'bbb595df6-gm8v4'
customer => preference => recommendation v1 from '76d747d99f-25h79': 17
----
...
现在程序应该随机返回负载均衡的 v1 and v2

[source,bash,subs="+macros,+attributes"]
----
# for i in `seq 1 10`;do curl $INGRESS_HOST:$INGRESS_PORT;done

customer => preference => recommendation v2 from 'bbb595df6-gm8v4': 1
customer => preference => recommendation v1 from '76d747d99f-25h79': 18
customer => preference => recommendation v2 from 'bbb595df6-gm8v4': 2
customer => preference => recommendation v1 from '76d747d99f-25h79': 19
customer => preference => recommendation v2 from 'bbb595df6-gm8v4': 3
customer => preference => recommendation v1 from '76d747d99f-25h79': 20
customer => preference => recommendation v2 from 'bbb595df6-gm8v4': 4
customer => preference => recommendation v1 from '76d747d99f-25h79': 21
customer => preference => recommendation v2 from 'bbb595df6-gm8v4': 5
customer => preference => recommendation v1 from '76d747d99f-25h79': 22
----
...
在放弃或失败前等待 N 秒.
首先，`recommendation v2` 通过取消注释调用该 `timeout()` 方法的行来引入一些等待时间。更新 `RecommendationVerticle.java` 使其表现缓慢，延迟时间为3秒。
